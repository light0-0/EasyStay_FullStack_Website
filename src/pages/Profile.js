      ...
      <div className="row profile-container">
        ...
        <div className="col-md-6 profile-container-col2">
          <div className="container mt-4  d-flex justify-content-between">
            ...
            <button className="btn btn-danger " id="redLogout" style={{borderRadius:"10px"}} onClick={logoutHandler}>
              Logout
            </button>
          </div>
          ...
          <div className="mt-3 create-listing">
            <Link to="/create-listing">
              <FaArrowAltCircleRight color="primary" /> &nbsp; <span id="a">Your Info or Rent Your
              Home</span>
            </Link>
          </div>
        </div>
